...
mixin _$TransferResponse {
  ...
  String? get recepient => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      description: freezed == description
          ...
          : description // ignore: cast_nullable_to_non_nullable
              as String?,
      recepient: freezed == recepient
          ? _value.recepient
          : recepient // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$TransferResponseImpl implements _TransferResponse {
  const _$TransferResponseImpl(
      {this.amount, this.message, this.description, this.recepient});
  ...
  @override
  String toString() {
    return 'TransferResponse(amount: $amount, message: $message, description: $description, recepient: $recepient)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.recepient, recepient) ||
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, amount, message, description, recepient);
...
abstract class _TransferResponse implements TransferResponse {
  const factory _TransferResponse(
      ...
      final String? message,
      final String? description,
      final String? recepient}) = _$TransferResponseImpl;
